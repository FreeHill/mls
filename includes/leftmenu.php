				<div class="span3">
					...
					<h4 class="navbar-inner" style="color:#fff; line-height:40px;">Members Login</h4>
					...
					<br class="clear" />
					<?php } ?>
					<h4 class="navbar-inner" style="color:#fff; line-height:40px; background-color: #0B7251;">Testimonials</h4>
					<div class="service-box2">
