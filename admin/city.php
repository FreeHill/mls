...
//echo "insert into mlm_city(`city_name`) values('$city')"; exit;
$cdi=$_REQUEST['cdi'];
$sdi=$_REQUEST['sdi'];


$cou=mysql_query("insert into mlm_city(`country_id`,`state_id`,`city_name`) values('$cdi','$sdi','$city')");
...
$cou=mysql_query("update mlm_city set city_name='$city' where city_id='$id'");
...
$act=mysql_query("update mlm_city set city_status='1' where city_id='$id'");
...
$act=mysql_query("update mlm_city set city_status='0' where city_id='$id'");
...
$det=mysql_query("delete from mlm_city where city_id='$id'");
						   ...
						   <form action="" method="post">
							...
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$ciy=mysql_query("select * from mlm_city where state_id='$_REQUEST[stta]' order by city_name asc");
									$i=1;
									$num=mysql_num_rows(mysql_query("select * from mlm_city where state_id='$_REQUEST[stta]'"));
									
									while($row_ciy=mysql_fetch_array($ciy))
									{
									?>
