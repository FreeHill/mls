...
if($clogo == "")
 ...
 $insert = mysql_query("update mlm_products set pro_name='$name',pro_cost='$cost',pro_bv='$bv',pro_logo='$cate_img_small',pro_contentimg='$cate_img',pro_desc='$desc',pro_longdesc='$ldesc',pro_features='$feature' where pro_id='$id'");
...
tinyMCE.triggerSave();
 ...
 if(document.getElementById('cost').value == "")
	...
	{
		alert("Enter the Product BV Value");
				...
				<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<div class="control-group">
						<label class="control-label" for="form-field-2">Product BV<span style="color:#FF0000;">*</span> : </label>
