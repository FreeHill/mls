...
header("location:inactive_user.php?del");

echo "<script>window.location='inactive_user.php?del';</script>";
...
if($result){?> <script>
window.location="inactive_user.php?del";
</script> <?php
}
 }
...
if($result){?> <script>
window.location="inactive_user.php?actsucc";
</script> <?php
}
 }
                           ...
                           <form action="" method="post">
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$usrr=mysql_query("select * from mlm_register where user_status='1' order by user_id desc");
									$i=1;
									...
									$profileproof_image="images/nouser.png";
											...
											<td class="td-actions" align="center">
												...
												<span>	
													...
													<a class="red" href="inactive_user.php?inact=<?php echo $row_usrr['user_id'];?>" onclick="if(confirm('Are you sure to activate this record')) { return true; } else { return false; }">
														<i class="icon-certificate bigger-130" title="click to activate"></i>
													</a>
													
													<?php } if($row_usrr['user_status']=='0') { ?>
												
												<a class="green" href="inactive_user.php?act=<?php echo $row_usrr['user_id']; ?>" onclick="if(confirm('Are you sure to deactivate this record')) { return true; } else { return false; }">
												...
												<a class="blue" href="user_edit.php?edit=<?php echo $row_usrr['user_id'];?>">
													...
													<a class="grey" href="inactive_user.php?delete=<?php echo $row_usrr['user_id'];?>" onclick="if(confirm('Are you sure to delete this record')) { return true; } else { return false; }">
