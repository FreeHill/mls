...
$det=mysql_query("delete from mlm_exemp_state where id ='$id' ");

if($det)
{

header("location:exempstates.php?del");

echo "<script>window.location='exempstates.php?del';</script>";
...
$sql = "delete from mlm_exemp_state where id='$del_id' ";
$result = mysql_query($sql);

}

if($result){?> <script>
window.location="exempstates.php?del";
</script> <?php
}
 }
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Exempted States</li>
					</ul><!--.breadcrumb-->
						  ...
						  ?> 
                           ...
                           <form action="" method="post">
							<div class="row-fluid">
								...
								<span style="float:right; padding-right:5px;"><a href="selectstate.php" style="color:#FFFFFF;">+ Add Exempted State</a></span>
								...
								<table class="table table-striped table-bordered table-hover">
									...
									$usrr=mysql_query("select * from mlm_exemp_state order by id desc");
									$i=1;
									$num=mysql_num_rows(mysql_query("select * from mlm_exemp_state"));
									...
									?>
										...
										<tr>
											...
											<td class="center">
												<label>
						<input type="checkbox" id="chkval[]" name="chkval[]" value="<?php echo $row_usrr['id']; ?>"  />
													<span class="lbl"></span>
												</label>
											</td>
											...
											<td class="center">
									         ...
									         <td><?php echo $row_usrr['statecode']; ?></td>
											 
											 <td><?php echo $row_usrr['statename']; ?></td>
											...
											{		
												  ...
												  <?php } ?>
													...
													<a class="grey" href="exempstates.php?delete=<?php echo $row_usrr['id'];?>" onclick="if(confirm('Are you sure to delete this record')) { return true; } else { return false; }">
