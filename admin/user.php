...
if (isset($_REQUEST['delete'])) {
    ...
    $det = mysql_query("delete from mlm_register where user_id ='$id' and user_id !='1'");
...
if (isset($_POST['mul_delete'])) {
    ...
    for ($i = 0; $i < count($checkbox); $i++) {
        ...
        $sql = "delete from mlm_register where user_id='$del_id' and user_id !='1'";
                        ...
                        <div class="row-fluid">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample-table-2">
                                ...
                                <tr>
                                    ...
                                    <th width="64">Membership</th>
                                    <th width="40">Direct Refferal</th>
                                ...
                                $usrr = mysql_query("select * from mlm_register where user_status != 5 order by user_id desc");
                                $i = 1;
                                ...
                                while ($row_usrr = mysql_fetch_array($usrr)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!--<a href="memberlevel.php?ussserid=<?php echo $row_usrr['user_profileid']; ?>">-->
                                            <?php echo $row_usrr['user_fname']; ?>
                                            <!--</a>-->
                                        </td>

                                        <td><?php echo $row_usrr['user_profileid']; ?></td>

                                        <td><?php echo member($row_usrr['user_membership']); ?></td>

                                        <td class="center"><?php echo directrefferalcount($row_usrr['user_profileid']); ?></td>
                                        ...
                                        <td class="td-actions" align="center">
                                            ...
                                            <div class="hidden-phone visible-desktop action-buttons">
                                                ...
                                                if ($row_usrr['user_id'] != '1') {
                                                    ...
                                                    <a onClick="window.open('change_membership.php?proid=<?php echo $row_usrr['user_profileid']; ?>', 'windowname1', 'scrollbars,resizable,width=480, height=287'); return false;" style="cursor:pointer;">
                                                        <i class="icon-user bigger-130" title="click to Change Membership"></i>
                                                    </a>
