...
$cou=mysql_query("insert into mlm_country(`country_name`) values('$country')");
...
$cou=mysql_query("update mlm_country set country_name='$country' where country_id='$id'");
...
$act=mysql_query("update mlm_country set country_status='1' where country_id='$id'");
...
$act=mysql_query("update mlm_country set country_status='0' where country_id='$id'");
...
$det=mysql_query("delete from mlm_country where country_id='$id'");
						   ...
						   <form action="" method="post">
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$con=mysql_query("select * from mlm_country order by country_name asc");
									$i=1;
									$num=mysql_num_rows(mysql_query("select * from mlm_country"));
									
									while($row_con=mysql_fetch_array($con))
									{
									
									
									$statee=mysql_num_rows(mysql_query("select * from mlm_state where country_id='$row_con[country_id]'"));
										?><tr>
