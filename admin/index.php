...
$log_count=mysql_num_rows(mysql_query($sql));

//echo $log_count; exit;

$fetv=mysql_fetch_array(mysql_query($sql));

if($log_count>0)
{
$_SESSION['admin_id']=$fetv['admin_id'];

echo "<script>window.location='dashboard.php';</script>";}
else
{
echo "<script>window.location='index.php?log_err';</script>";
}
}
