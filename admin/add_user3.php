...
if (isset($_REQUEST['submit'])) {
    ...
    $sel = mysql_fetch_array(mysql_query("select * from mlm_register where user_id='$uid'"));
            ...
            <div class="row-fluid">
                ...
                <div>
                    <div style="float:left;">
                        <span class="label label-info label-large arrowed-in-right"
                              style="padding:14px; width:200px; font-size:16px;">1.Basic Details</span>
                    </div>

                    <div style="float:left;">
                        <span class="label label-info label-large arrowed-in-right arrowed-in"
                              style="padding:14px; width:200px; font-size:16px;">&nbsp;&nbsp;&nbsp;2. Personal Details</span>
                    </div>

                    <div style="float:left;">
                        <span class="label label-info label-large arrowed-in"
                              style="padding:14px; width:200px; font-size:16px;">&nbsp;&nbsp;&nbsp;3.Nominee Details</span>
                    </div>
                ...
                <div class="span12">
                    ...
                    <form class="form-horizontal" name="general" method="post" action="" onsubmit="return nvalidate();"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="radio" name="icid" id="vcid" style="opacity:1;" value="Voters ID"
                                   onclick="return card(this.value);" checked="checked"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Voters
                            ID <input type="radio" name="icid" id="pcid" style="opacity:1;" value="PAN Card"
                                      onclick="return card(this.value);"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PAN Card
                            <input type="radio" name="icid" id="psid" style="opacity:1;" value="Passport"
                                   onclick="return card(this.value);"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Passport
                            <input type="radio" name="icid" id="dlid" style="opacity:1;" value="Driving License"
                                   onclick="return card(this.value);"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Driving
                            License
                            <input type="radio" name="icid" id="otid" style="opacity:1;" value="others"
