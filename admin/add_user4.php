...
header("location:add_user3.php?uid='$_REQUEST[uid]'");
		...
		<div class="main-container container-fluid">
			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<span class="label label-info label-large arrowed-in-right" style="padding:14px 10px; width:130px; font-size:16px;">1.Basic Details</span>
					</div>
					
					<div style="float:left;">
					<span class="label label-info label-large arrowed-in-right arrowed-in" style="padding:14px 10px; width:165px; font-size:16px;">&nbsp;&nbsp;&nbsp;2. Personal Details</span>
					</div>
					
					<div style="float:left;">
					<span class="label label-info label-large arrowed-in-right arrowed-in" style="padding:14px 10px; width:160px; font-size:16px;">&nbsp;&nbsp;&nbsp;3.Nominee Details</span>
					</div>
					
					<div style="float:left;">
					<span class="label label-info label-large arrowed-in" id="classval4" style="padding:14px 10px; width:170px; font-size:15px;">&nbsp;&nbsp;&nbsp;4. Membership Details </span>
					</div>
