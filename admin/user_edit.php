...
if (isset($_REQUEST['update1'])) {
    ...
    //echo "update mlm_register set user_sponsername='$name',user_sponserid='$sponserid',user_placement='$pos',user_placementid='$pid',user_pancard='$pancard' where user_id='$uid'"; exit;

    $insert = mysql_query("update mlm_register set user_sponsername='$name',user_sponserid='$sponserid',user_placement='$pos',user_placementid='$pid',user_pancard='$pancard' where user_id='$uid'");
...
//            set $image_error = No Image Uploaded if profile is required
            $image_error = "";
        } else {
        ...
        if (!in_array(strtolower($split_name[1]), $extensions))
        {
            $image_error = "Image type should a type of " . implode(", ", $extensions);
            ...
            if ($img_size < 2097152) { //1048576 = 1MB
                ...
                $image_error = "Image size should be less than 2MB";
...
//    echo "update mlm_register set user_fname='$fname',user_secondname='$secname',user_lname='$lname',user_dob='$date',user_phone='$phone',user_email='$email',user_accholdername='$holder',user_branch='$branch',user_ifsccode='$ifsccode',user_accno='$accno',user_bankname='$bank_name',user_commaddr1='$caddr1',user_commaddr2='$cddr2',user_city='$ccity',user_state='$cstate',user_country='$ccountry',user_postalcode='$czipcode' ,user_paddr1='$cpaddr1',user_paddr2='$cpddr2',user_pcity='$cpcity',user_pstate='$cpstate',user_pcountry='$cpcountry',user_ppostalcode='$cpzipcode',user_image='$cate_img_small' where user_id='$uid'"; exit;
    ...
    if ($image_error == "") {
        ...
        if ($insert) {
            ...
            //remove old profile image when there is a new upload and there is an old image
            if ($profile_image != "" && $_REQUEST['hide_image'] != "") {
...
$edit = mysql_fetch_array(mysql_query("select * from mlm_register where user_id='$_REQUEST[edit]'"));
?>
<style>
        ...
        <div class="page-content">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <form class="form-horizontal" name="general" method="post" action=""
                        ...
                        <div class="control-group">
                            <label class="control-label" for="form-field-1">Sponser Name &nbsp;<span
                                        style="color:#FF0000;">*</span>
                                : </label>

                            <div class="controls">
                                <input type="text" name="sname" id="sname"
                                       value="<?php echo $edit['user_sponsername']; ?>"/>
                            </div>
                        </div>

                        <div class="control-group">
                            <label class="control-label" for="form-field-2">Sponser id &nbsp;<span
                                        style="color:#FF0000;">*</span> : </label>

                            <div class="controls">
                            <span id="spid"><input type="text" name="sid" id="sid"
                                                   value="<?php echo $edit['user_sponserid']; ?>"/></span>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="form-field-1">Placement Position &nbsp;<span
                                        style="color:#FF0000;">*</span> : </label>

                            <div class="controls">
                                <select name="position" id="position" onchange="showpos(this.value)"
                                        onfocus="focuspos();">
                                    <option value="">Select Position</option>
                                    <option value="L" <?php if ($edit['user_placement'] == "L") { ?> selected="selected" <?php } ?> >
                                        Left
                                    </option>
                                    <option value="R" <?php if ($edit['user_placement'] == "R") { ?> selected="selected" <?php } ?>>
                                        Right
                                    </option>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="form-field-1">Placement Id &nbsp;<span
                                        style="color:#FF0000;">*</span>
                                : </label>
                            ...
                            <div class="controls">
									<span id="pid">
										<input type="text" name="placeid" id="placeid"
                                               value="<?php echo $edit['user_placementid']; ?>"/>
										</span>
                            </div>
                            ...
                            <div class="form-actions">
                                ...
                                --> <input type="submit" name="update1" value="SUBMIT" class="btn btn-info"
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <form class="form-horizontal" name="general" method="post" action=""
                          onsubmit="return uservalidate2();" enctype="multipart/form-data">
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="branch" id="branch"
                                       value="<?php echo $edit['user_branch']; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="form-field-1"> Current Image : </label>
                        ...
                        <div class="control-group">
                            ...
                            <label style="border-bottom:1px #CCCCCC solid; font-weight:bold;">Communication
                                Address </label>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="form-field-1">City &nbsp;<span
                                        style="color:#FF0000;">*</span>
                                : </label>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="cpaddr1" id="cpaddr1"
                                       value="<?php echo $edit['user_paddr1']; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="cpaddr2" id="cpaddr2"
                                       value="<?php echo $edit['user_paddr2']; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            --> <input type="submit" name="update2" value="SUBMIT" class="btn btn-info"
                                       style="font-weight:bold;">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <div class="form-actions">
                        ...
                        --> <input type="submit" name="update3" value="SUBMIT" class="btn btn-info"
                                   style="font-weight:bold;">
