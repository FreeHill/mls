                          ...
                          <form action="" method="post">
							...
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$inbdb=mysql_query("select * from mlm_outbox where (outbox_userid='admin' and outbox_fromstatus='0') and outbox_fwdstatus='1' order by outbox_id desc");
									$i=1;
									$num=mysql_num_rows(mysql_query("select * from mlm_outbox where (outbox_userid='admin' and outbox_fromstatus='0') and outbox_fwdstatus='1' order by outbox_id desc"));
									
									while($row_inbdb=mysql_fetch_array($inbdb))
									{
						if($row_inbdb['outbox_usertype'] == '2')
									{	
									$useinb=mysql_fetch_array(mysql_query("select * from mlm_register where user_id='$row_inbdb[outbox_userid]'"));
