...
$id=$_REQUEST['reqreply'];

$reqfet=mysql_fetch_array(mysql_query("select * from mlm_withdrawrequsets where req_id='$id'"));
$userfet=mysql_fetch_array(mysql_query("select * from mlm_register where user_id='$reqfet[req_userid]'"));
...
$cou=mysql_query("update mlm_withdrawrequsets set req_rpstatus='1' where req_id='$id'");
$user=mysql_query("update mlm_register set accumulated_bv='$balamt' where user_id='$reqfet[req_userid]'");
if($cou)
{
...
$det=mysql_query("delete from mlm_withdrawrequsets where req_id='$id'");
                          ...
                          <form action="" method="post">
							...
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$req=mysql_query("select * from mlm_withdrawrequsets where req_status=0 order by req_id desc");
									$i=1;
									$num=mysql_num_rows(mysql_query("select * from mlm_withdrawrequsets where req_status=0 order by req_id desc"));
									
									while($row_req=mysql_fetch_array($req))
									{
				 $req_user=mysql_fetch_array(mysql_query("select * from mlm_register where user_id='$row_req[req_userid]'"));
									?>
