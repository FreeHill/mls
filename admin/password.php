...
if(isset($_REQUEST['submit']))
{
 ...
 $admin_id=$_SESSION['admin_id'];
	...
	$cur_pass =mysql_real_escape_string($_REQUEST['cur_pass']);
	$current_pass =mysql_real_escape_string($_REQUEST['current_pass']);
	$new_pass = mysql_real_escape_string($_REQUEST['new_pass']); 
	$con_new_pass =mysql_real_escape_string($_REQUEST['con_new_pass']);
