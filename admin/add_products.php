...
if(isset($_REQUEST['submit']))
{
	...
	$ind_bonus=mysql_real_escape_string($_REQUEST['indirect_bonus']);
...
if($clogo == "")
 ...
 $insert = mysql_query("INSERT INTO mlm_products (pro_name,pro_cost,pro_bv,pro_logo,pro_contentimg,pro_desc,pro_longdesc,pro_features,pro_date,pro_qnty,pro_qnty_type,pro_bonus,pro_url,pro_indirect_bonus) VALUES ('$name','$cost','$bv','$cate_img_small','$cate_img','$desc','$ldesc','$feature',NOW(),'$qty','$qty_type','$bonus','$url','$ind_bonus')");
...
tinyMCE.triggerSave();
 ...
 if(document.getElementById('cost').value == "")
	...
	{
		alert("Enter the Product Rupees Value");
						...
						<div class="span12">
							...
							<form class="form-horizontal" name="general"  method="post" action="" onsubmit="return provalidate();" enctype="multipart/form-data" />
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" name="indirect_bonus" id="indirect_bonus" />
									</div>
								</div>
								<div class="control-group">
