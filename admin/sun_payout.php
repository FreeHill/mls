			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Payout details</li>
					</ul><!--.breadcrumb-->
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									<thead>
										<tr>
											...
											<th width="83" >Payout Date</th>
										<th width="83" >Payout Day</th>
									...
									$payy=mysql_query("select * from mlm_payoutcalc WHERE bonus_type IN (3,4) group by pay_date order by pay_id desc");
									$i=1;
									$num=mysql_num_rows(mysql_query("select * from mlm_payoutcalc  group by pay_date"));
									...
									?>
										...
										<tr>
											...
											<td>
											 ...
											 <td><?php echo date("l",strtotime($row_payy['pay_date'])); ?></td>
											...
											<td class="td-actions" align="center">
												...
												<span>	
													<a href="sun_payout_detail.php?detail=<?php echo $row_payy['pay_date'];?>" >
