...
$cou=mysql_query("insert into mlm_help(`help_qtn`,`help_ans`,`help_date`) values('$qtn','$ans',NOW())");
...
$cou=mysql_query("update mlm_help set help_qtn='$qtn',help_ans='$ans' where help_id='$id'");
...
$act=mysql_query("update mlm_help set help_status='1' where help_id='$id'");
...
$act=mysql_query("update mlm_help set help_status='0' where help_id='$id'");
...
$det=mysql_query("delete from mlm_help where help_id='$id'");
						   ...
						   ?>
							...
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$help=mysql_query("select * from mlm_help order by help_id desc");
									$i=1;
									$num=mysql_num_rows(mysql_query("select * from mlm_help"));
									
									while($row_help=mysql_fetch_array($help))
									{
									?>
