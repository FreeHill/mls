...
$wedo=$_REQUEST['wedo'];
$cms_greetings=$_REQUEST['greetings'];
$num=mysql_num_rows(mysql_query("select * from mlm_cms where cms_id='1'"));

//echo $num; 

if($num=='1')
{
$up=mysql_query("update mlm_cms set cms_aboutus='$about',cms_terms='$terms',cms_privacy='$privacy',cms_welcome='$welcome',cms_whatwedo='$wedo',cms_greetings='$cms_greetings' where cms_id='1'");
}
else 
{ 
...
$fetch=mysql_fetch_array(mysql_query("select * from mlm_cms where cms_id='1'"));
 ?>
						  ...
						  ?> 
						   ...
						   ?>
							...
							<div class="control-group">
								...
								<div class="control-group">
									<label class="control-label" for="form-field-1">Welcome Text <span style="color:#FF0000;">*</span> : </label>

									<div class="controls">
										<textarea name="welcome" id="welcome"><?php echo $fetch['cms_welcome']; ?></textarea>
									</div>
								</div>
								
								<div class="control-group">
									<label class="control-label" for="form-field-1">What We Do <span style="color:#FF0000;">*</span> : </label>

									<div class="controls">
										<textarea name="wedo" id="wedo"><?php echo $fetch['cms_whatwedo']; ?></textarea>
									</div>
								</div>
