...
$fwdval=mysql_fetch_array(mysql_query("select * from mlm_outbox where outbox_id='$_REQUEST[detail]'"));

if(isset($_REQUEST['usrviewed']))
{
//echo "update mlm_outbox set outbox_readstatus='1' where outbox_id='$_REQUEST[detail]'"; exit;
mysql_query("update mlm_outbox set outbox_readstatus='1' where outbox_id='$_REQUEST[detail]'");
}
 ?>
