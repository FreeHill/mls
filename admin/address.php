...
$menu7='class="active"';
$sel_addr=mysql_fetch_array(mysql_query("SELECT * FROM mlm_address WHERE addr_id='1'"));
 //echo "SELECT * FROM skill_admin WHERE admin_id='$_SESSION[admin_id]'";
 //echo $sel_addr['adminpassword'];
if(isset($_REQUEST['submit']))
{
	...
	//echo "UPDATE mlm_address SET addr_name='$username',addr_companyname='$company_name',addr_mobile='$mobile',addr_country='$country',addr_state='$state',addr_city='$city',addr_area='$area',addr_zipcode='$zipcode' WHERE addr_id='1'"; exit;
	
	
			$update = mysql_query("UPDATE mlm_address SET addr_name='$username',addr_companyname='$company_name',addr_mobile='$mobile',addr_country='$country',addr_state='$state',addr_city='$city',addr_area='$area',addr_zipcode='$zipcode' WHERE addr_id='1'");
			if($update)
			{
