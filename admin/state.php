...
//echo "insert into mlm_state(`state_name`) values('$state')"; exit;

$sasdad=mysql_query("insert into mlm_state(`country_id`,`state_name`) values('$conid','$state')");
...
$cou=mysql_query("update mlm_state set state_name='$state' where state_id='$sid'");
...
$act=mysql_query("update mlm_state set state_status='1' where state_id='$id'");
...
$act=mysql_query("update mlm_state set state_status='0' where state_id='$id'");
...
$det=mysql_query("delete from mlm_state where state_id='$id'");
                        ...
                        <form action="" method="post">
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$staat=mysql_query("select * from mlm_state where country_id='$_REQUEST[conn]' order by state_name asc");
									$i=1;
									$num=mysql_num_rows(mysql_query("select * from mlm_state where country_id='$_REQUEST[conn]'"));
									
									while($row_staat=mysql_fetch_array($staat))
									{
									
									$cityy=mysql_num_rows(mysql_query("select * from mlm_city where state_id='$row_staat[state_id]'"));
