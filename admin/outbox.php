                          ...
                          <form action="" method="post">
							...
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$inbdb=mysql_query("select * from mlm_outbox where (outbox_userid='admin' and outbox_fromstatus='0') order by outbox_id desc");
									$i=1;
									$num=mysql_num_rows(mysql_query("select * from mlm_outbox where (outbox_userid='admin' and outbox_fromstatus='0') order by outbox_id desc"));
