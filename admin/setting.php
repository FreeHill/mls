...
{
$wtitle=mysql_real_escape_string($_REQUEST['title']);
$wname=mysql_real_escape_string($_REQUEST['name']);
$wkey=mysql_real_escape_string($_REQUEST['keywords']);
$wdes=mysql_real_escape_string($_REQUEST['desc']);
$wteam=mysql_real_escape_string($_REQUEST['team']);
$wadmin=mysql_real_escape_string($_REQUEST['email']);
$wurl=mysql_real_escape_string($_REQUEST['url']);

$wpayid=mysql_real_escape_string($_REQUEST['paypal']);
//echo $_FILES['logo']['name']; exit;

if($_FILES['logo']['name']!='')
{
$wlogo=mysql_real_escape_string($_FILES['logo']['name']);
