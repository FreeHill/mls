			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Binary referral</li>
					</ul><!--.breadcrumb-->
						   ...
						   ?>
							...
							Binary Payout
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$payy=mysql_query("select * from mlm_payoutcalc group by pay_date order by pay_id desc");
									$i=1;
									...
									?>
										...
										<tr>
											...
											<td class="td-actions" align="center">
												...
												<span>	
													<a href="binary_payout.php?detail=<?php echo $row_payy['pay_date'];?>" >
