...
<ul id="tabmenu" style="margin-bottom:20px;">
   <li>
        ...
        <ul>
			...
			<img src="images/paypal.jpeg" style="width:120px; cursor:pointer;" alt="Paypal">
			
			</a><br>
			<a href="javascript:void(0);" style="text-decoration:none; color:#CCCCCC; ">Click image to pay the amount using paypal</a></li>
	 ...
	 <li>
       <a href="javascript:void(0);">Offline Payment</a>
		...
		<form class="register-form" method="post" action="registerfunc.php">
			...
			<div style="float:left;" class="divclass">Enter Payment Id <span style="color:#FF0000;">*</span></div>
			<div style="float:left;" class="divclass">  : &nbsp;&nbsp;</div>
			<div style="float:left;"> <input type="text" name="payid" id="payid" onBlur="return payvald(this.value);" required='required'>
			<br><div id="payyv" class="divclass" style="margin-left:-30px;"></div>
...
<input type="hidden" name="profileid" id="profileid" value="<?=$_REQUEST['id'];?>" />
<input type="hidden" name="paytype" id="paytype" value="1">
<button class="btn btn-primary" name="registrationfive" id="registrationfive" type="submit" style="margin-right:5px;">Submit</button>&nbsp;&nbsp;
...
<div style="border-bottom:1px solid #CCCCCC;">&nbsp;</div>
	 ...
	 <br><span style="font-weight:normal; text-align:justify; color:#666666;">Make a payment using below bank Details, after payment admin send payment id , use that payment id complete the registration.</span>
	   </div>
	   ...
	   <div class="divclass" style="font-weight:normal; line-height:25px; margin-bottom:10px;"> 
	   ...
	   <td><strong style="color:#C40B06;"><?php echo $memrow['bank_name'];?></strong></td>
	   
	   </tr>
	   <tr>
	   <td>
	   <img src="uploads/banklogo/<?php echo $memrow['bank_logo'];?>" style="width:120px; height:80px; ">
	   </td></tr>
	   ...
	   <td>:&nbsp;&nbsp;&nbsp;</td> 
	   <td><strong><?php echo $memrow['account_name'];?></strong></td>
	   ...
	   <td>Branch Name</td>
	   <td>:&nbsp;&nbsp;&nbsp;</td> 
	   <td><strong><?php echo $memrow['branch_name'];?></strong></td>
	   
	   </tr>
	     <tr>
	   <td>Account Number</td>
	   <td>:&nbsp;&nbsp;&nbsp;</td> 
	   <td><strong><?php echo $memrow['account_number'];?></strong></td>
	   ...
	   <td>IFSC Code</td>
	   <td>:&nbsp;&nbsp;&nbsp;</td> 
	   <td><strong><?php echo $memrow['ifsci'];?></strong></td>
