...
$detail = mysql_fetch_array(mysql_query("select * from mlm_register where user_profileid='$_REQUEST[detail]'"));
        ...
        <div class="page-content">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <div class="control-group">
                        <label style="border-bottom:1px #CCCCCC solid; font-weight:bold; color:#FF6600;">Permanent
                            Address &nbsp
                        </label>
                    </div>
