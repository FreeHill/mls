...
$act=mysql_query("update mlm_wastage set waste_status='1' where waste_id ='$id'");
...
$act=mysql_query("update mlm_wastage set waste_status='0' where waste_id ='$id'");
...
$det=mysql_query("delete from mlm_wastage where waste_id ='$id'");
						...
						<div class="span12">
							...
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$was=mysql_query("select * from mlm_wastage order by waste_id desc");
									
									
									$i=1;
									$num=mysql_num_rows(mysql_query("select * from mlm_wastage"));
									
									while($row_was=mysql_fetch_array($was))
									{
									
									
										$pro=mysql_fetch_array(mysql_query("select * from mlm_products where pro_id='$row_was[waste_proid]'"));
									?>
