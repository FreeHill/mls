                          ...
                          <form action="" method="post">
							...
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$req=mysql_query("select * from mlm_withdrawrequsets where req_status=1 order by req_id desc");
									$i=1;
									$num=mysql_num_rows(mysql_query("select * from mlm_withdrawrequsets where req_status=1 order by req_id desc"));
