...
$del=mysql_query("update mlm_outbox set outbox_tostatus='1' where outbox_id='$del_id'");
$result = mysql_query($sql);
}

if($result){?> <script>
window.location="inbox.php?del";
</script> <?php
}
 }
 ?>
                          ...
                          <form action="" method="post">
							...
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$inbdb=mysql_query("select * from mlm_outbox where (outbox_usertype='1' and outbox_tostatus='0') order by outbox_id desc");
									$i=1;
									$num=mysql_num_rows(mysql_query("select * from mlm_outbox where (outbox_usertype='1' and outbox_tostatus='0') order by outbox_id desc"));
